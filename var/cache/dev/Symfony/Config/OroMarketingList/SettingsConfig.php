...
namespace Symfony\Config\OroMarketingList;
...
class SettingsConfig 
{
    ...
    public function featureEnabled(array $value = []): \Symfony\Config\OroMarketingList\Settings\FeatureEnabledConfig
    {
        if (null === $this->featureEnabled) {
            $this->_usedProperties['featureEnabled'] = true;
            $this->featureEnabled = new \Symfony\Config\OroMarketingList\Settings\FeatureEnabledConfig($value);
        } elseif ([] !== $value) {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('feature_enabled', $value)) {
            $this->_usedProperties['featureEnabled'] = true;
            $this->featureEnabled = new \Symfony\Config\OroMarketingList\Settings\FeatureEnabledConfig($value['feature_enabled']);
