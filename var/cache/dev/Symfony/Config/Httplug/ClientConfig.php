...
class ClientConfig 
{
    ...
    public function plugin(array $value = []): \Symfony\Config\Httplug\ClientConfig\PluginConfig
    {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('plugins', $value)) {
            $this->_usedProperties['plugins'] = true;
            $this->plugins = array_map(function ($v) { return new \Symfony\Config\Httplug\ClientConfig\PluginConfig($v); }, $value['plugins']);
            unset($value['plugins']);
        }
