...
require_once __DIR__.\DIRECTORY_SEPARATOR.'ResolversConfig'.\DIRECTORY_SEPARATOR.'OroGaufretteConfig.php';
...
class ResolversConfig 
{
    ...
    public function oroGaufrette(array $value = []): \Symfony\Config\LiipImagine\ResolversConfig\OroGaufretteConfig
    {
        if (null === $this->oroGaufrette) {
            $this->_usedProperties['oroGaufrette'] = true;
            $this->oroGaufrette = new \Symfony\Config\LiipImagine\ResolversConfig\OroGaufretteConfig($value);
        } elseif ([] !== $value) {
            throw new InvalidConfigurationException('The node created by "oroGaufrette()" has already been initialized. You cannot pass values the second time you call oroGaufrette().');
        }
    
        return $this->oroGaufrette;
    }
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('oro_gaufrette', $value)) {
            $this->_usedProperties['oroGaufrette'] = true;
            $this->oroGaufrette = new \Symfony\Config\LiipImagine\ResolversConfig\OroGaufretteConfig($value['oro_gaufrette']);
            unset($value['oro_gaufrette']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['oroGaufrette'])) {
            $output['oro_gaufrette'] = $this->oroGaufrette->toArray();
        }
