...
class EnforceConfig 
{
    ...
    public function browserAdaptive(array $value = []): \Symfony\Config\NelmioSecurity\Csp\Enforce\BrowserAdaptiveConfig
    {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('browser_adaptive', $value)) {
            $this->_usedProperties['browserAdaptive'] = true;
            $this->browserAdaptive = new \Symfony\Config\NelmioSecurity\Csp\Enforce\BrowserAdaptiveConfig($value['browser_adaptive']);
