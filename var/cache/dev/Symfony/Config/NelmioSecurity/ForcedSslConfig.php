...
class ForcedSslConfig 
{
     ...
     * @return $this
     */
    public function hstsMaxAge($value): self
    {
     ...
     * @return $this
     */
    public function hstsSubdomains($value): self
    {
     ...
     * @return $this
     */
    public function hstsPreload($value): self
    {
     ...
     * @return $this
     */
    public function whitelist($value): self
    {
        $this->_usedProperties['whitelist'] = true;
     ...
     * @return $this
     */
    public function redirectStatusCode($value): self
    {
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['whitelist'])) {
