...
namespace Symfony\Config\Security\FirewallConfig\OrganizationRememberMe;
...
class TokenProviderConfig 
{
    ...
    public function doctrine(array $value = []): \Symfony\Config\Security\FirewallConfig\OrganizationRememberMe\TokenProvider\DoctrineConfig
    {
        if (null === $this->doctrine) {
            $this->_usedProperties['doctrine'] = true;
            $this->doctrine = new \Symfony\Config\Security\FirewallConfig\OrganizationRememberMe\TokenProvider\DoctrineConfig($value);
        } elseif ([] !== $value) {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('doctrine', $value)) {
            $this->_usedProperties['doctrine'] = true;
            $this->doctrine = new \Symfony\Config\Security\FirewallConfig\OrganizationRememberMe\TokenProvider\DoctrineConfig($value['doctrine']);
