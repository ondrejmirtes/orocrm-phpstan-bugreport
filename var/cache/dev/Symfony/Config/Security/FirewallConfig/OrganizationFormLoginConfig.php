 ...
 */
class OrganizationFormLoginConfig 
{
    private $provider;
    private $rememberMe;
     ...
     * @return $this
     */
    public function organizationParameter($value): self
    {
        $this->_usedProperties['organizationParameter'] = true;
        $this->organizationParameter = $value;
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('organization_parameter', $value)) {
            $this->_usedProperties['organizationParameter'] = true;
            $this->organizationParameter = $value['organization_parameter'];
            unset($value['organization_parameter']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['organizationParameter'])) {
            $output['organization_parameter'] = $this->organizationParameter;
        }
