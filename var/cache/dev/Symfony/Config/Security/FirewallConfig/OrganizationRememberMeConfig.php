...
require_once __DIR__.\DIRECTORY_SEPARATOR.'OrganizationRememberMe'.\DIRECTORY_SEPARATOR.'TokenProviderConfig.php';
 ...
 */
class OrganizationRememberMeConfig 
{
    private $secret;
    private $service;
    ...
    public function tokenProvider(array $value = []): \Symfony\Config\Security\FirewallConfig\OrganizationRememberMe\TokenProviderConfig
    {
        if (null === $this->tokenProvider) {
            $this->_usedProperties['tokenProvider'] = true;
            $this->tokenProvider = new \Symfony\Config\Security\FirewallConfig\OrganizationRememberMe\TokenProviderConfig($value);
        } elseif ([] !== $value) {
     ...
     * @return $this
     */
    public function csrfProtectedMode($value): self
    {
        $this->_usedProperties['csrfProtectedMode'] = true;
        $this->csrfProtectedMode = $value;
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('token_provider', $value)) {
            $this->_usedProperties['tokenProvider'] = true;
            $this->tokenProvider = new \Symfony\Config\Security\FirewallConfig\OrganizationRememberMe\TokenProviderConfig($value['token_provider']);
        ...
        if (array_key_exists('csrf_protected_mode', $value)) {
            $this->_usedProperties['csrfProtectedMode'] = true;
            $this->csrfProtectedMode = $value['csrf_protected_mode'];
            unset($value['csrf_protected_mode']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['csrfProtectedMode'])) {
            $output['csrf_protected_mode'] = $this->csrfProtectedMode;
        }
