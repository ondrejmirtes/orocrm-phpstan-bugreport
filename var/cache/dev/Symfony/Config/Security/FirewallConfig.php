...
require_once __DIR__.\DIRECTORY_SEPARATOR.'FirewallConfig'.\DIRECTORY_SEPARATOR.'WsseConfig.php';
...
require_once __DIR__.\DIRECTORY_SEPARATOR.'FirewallConfig'.\DIRECTORY_SEPARATOR.'Oauth2Config.php';
...
require_once __DIR__.\DIRECTORY_SEPARATOR.'FirewallConfig'.\DIRECTORY_SEPARATOR.'OrganizationFormLoginConfig.php';
...
require_once __DIR__.\DIRECTORY_SEPARATOR.'FirewallConfig'.\DIRECTORY_SEPARATOR.'OrganizationHttpBasicConfig.php';
...
require_once __DIR__.\DIRECTORY_SEPARATOR.'FirewallConfig'.\DIRECTORY_SEPARATOR.'OrganizationRememberMeConfig.php';
...
class FirewallConfig 
{
    ...
    private $organizationFormLogin;
    private $jsonLogin;
    private $jsonLoginLdap;
    private $organizationHttpBasic;
    private $oauth;
    private $httpBasic;
    private $httpBasicLdap;
    private $rememberMe;
    private $organizationRememberMe;
    private $anonymous;
    ...
    public function wsse(array $value = []): \Symfony\Config\Security\FirewallConfig\WsseConfig
    {
        if (null === $this->wsse) {
            $this->_usedProperties['wsse'] = true;
            $this->wsse = new \Symfony\Config\Security\FirewallConfig\WsseConfig($value);
        } elseif ([] !== $value) {
            throw new InvalidConfigurationException('The node created by "wsse()" has already been initialized. You cannot pass values the second time you call wsse().');
        }
    ...
    public function oauth2(array $value = []): \Symfony\Config\Security\FirewallConfig\Oauth2Config
    {
        if (null === $this->oauth2) {
            $this->_usedProperties['oauth2'] = true;
            $this->oauth2 = new \Symfony\Config\Security\FirewallConfig\Oauth2Config($value);
        } elseif ([] !== $value) {
            throw new InvalidConfigurationException('The node created by "oauth2()" has already been initialized. You cannot pass values the second time you call oauth2().');
        }
    ...
    public function organizationFormLogin(array $value = []): \Symfony\Config\Security\FirewallConfig\OrganizationFormLoginConfig
    {
        if (null === $this->organizationFormLogin) {
            $this->_usedProperties['organizationFormLogin'] = true;
            $this->organizationFormLogin = new \Symfony\Config\Security\FirewallConfig\OrganizationFormLoginConfig($value);
        } elseif ([] !== $value) {
            throw new InvalidConfigurationException('The node created by "organizationFormLogin()" has already been initialized. You cannot pass values the second time you call organizationFormLogin().');
        }
    
        return $this->organizationFormLogin;
    }
    ...
    public function organizationHttpBasic(array $value = []): \Symfony\Config\Security\FirewallConfig\OrganizationHttpBasicConfig
    {
        if (null === $this->organizationHttpBasic) {
            $this->_usedProperties['organizationHttpBasic'] = true;
            $this->organizationHttpBasic = new \Symfony\Config\Security\FirewallConfig\OrganizationHttpBasicConfig($value);
        } elseif ([] !== $value) {
            throw new InvalidConfigurationException('The node created by "organizationHttpBasic()" has already been initialized. You cannot pass values the second time you call organizationHttpBasic().');
        }
    
        return $this->organizationHttpBasic;
    }
    ...
    public function organizationRememberMe(array $value = []): \Symfony\Config\Security\FirewallConfig\OrganizationRememberMeConfig
    {
        if (null === $this->organizationRememberMe) {
            $this->_usedProperties['organizationRememberMe'] = true;
            $this->organizationRememberMe = new \Symfony\Config\Security\FirewallConfig\OrganizationRememberMeConfig($value);
        } elseif ([] !== $value) {
            throw new InvalidConfigurationException('The node created by "organizationRememberMe()" has already been initialized. You cannot pass values the second time you call organizationRememberMe().');
        }
    
        return $this->organizationRememberMe;
    }
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('wsse', $value)) {
            $this->_usedProperties['wsse'] = true;
            $this->wsse = new \Symfony\Config\Security\FirewallConfig\WsseConfig($value['wsse']);
            unset($value['wsse']);
        }
        ...
        if (array_key_exists('oauth2', $value)) {
            $this->_usedProperties['oauth2'] = true;
            $this->oauth2 = new \Symfony\Config\Security\FirewallConfig\Oauth2Config($value['oauth2']);
            unset($value['oauth2']);
        }
        ...
        if (array_key_exists('organization_form_login', $value)) {
            $this->_usedProperties['organizationFormLogin'] = true;
            $this->organizationFormLogin = new \Symfony\Config\Security\FirewallConfig\OrganizationFormLoginConfig($value['organization_form_login']);
            unset($value['organization_form_login']);
        }
        ...
        if (array_key_exists('organization_http_basic', $value)) {
            $this->_usedProperties['organizationHttpBasic'] = true;
            $this->organizationHttpBasic = new \Symfony\Config\Security\FirewallConfig\OrganizationHttpBasicConfig($value['organization_http_basic']);
            unset($value['organization_http_basic']);
        }
        ...
        if (array_key_exists('organization_remember_me', $value)) {
            $this->_usedProperties['organizationRememberMe'] = true;
            $this->organizationRememberMe = new \Symfony\Config\Security\FirewallConfig\OrganizationRememberMeConfig($value['organization_remember_me']);
            unset($value['organization_remember_me']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['wsse'])) {
            $output['wsse'] = $this->wsse->toArray();
        }
        ...
        if (isset($this->_usedProperties['oauth2'])) {
            $output['oauth2'] = $this->oauth2->toArray();
        }
        ...
        if (isset($this->_usedProperties['organizationFormLogin'])) {
            $output['organization_form_login'] = $this->organizationFormLogin->toArray();
        }
        ...
        if (isset($this->_usedProperties['organizationHttpBasic'])) {
            $output['organization_http_basic'] = $this->organizationHttpBasic->toArray();
        }
        ...
        if (isset($this->_usedProperties['organizationRememberMe'])) {
            $output['organization_remember_me'] = $this->organizationRememberMe->toArray();
        }
